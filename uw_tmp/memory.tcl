...
set_global_assignment -section_id {memory} -name {EDA_SIMULATION_TOOL} {MODELSIM (VHDL OUTPUT FROM QUARTUS II)}
set_global_assignment -name {EDIF_FILE} {memory.edf}
...
set_global_assignment -section_id {memory} -name {DEVICE} {EP2S15F484C5}
set_global_assignment -name {FAMILY} {STRATIX II}
set_global_assignment -name {PROJECT_SHOW_ENTITY_NAME} {OFF}
if { [file exists {memory_pnr_constraints.tcl}] } {
  source memory_pnr_constraints.tcl
}
