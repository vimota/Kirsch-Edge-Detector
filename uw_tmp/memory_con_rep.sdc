...
# Attributes
#################
set_attribute -name use_dffenable -value "0" -net -type default o_valid -design rtl 
set_attribute -name use_dffenable -value "0" -net -type default first_bubble -design rtl 
