...
set_attribute -name use_dffenable -value "0" -net -type default m_o_valid -design rtl 
set_attribute -name use_dffenable -value "0" -net -type default u_flow/max_dir(2) -design rtl 
set_attribute -name use_dffenable -value "0" -net -type default u_flow/max_dir(1) -design rtl 
